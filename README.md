...
```json
{
  "mcpServers": {
    "bitrix24": {
      ...
      "args": [
        "--from",
        "git+https://github.com/a-shipilo/bitrix24-mcp-server@v0.2.3",
        "bitrix24-mcp-server"
      ],
      "env": {
...
`@v0.2.3` фиксирует версию. Чтобы всегда брать последнюю версию из `main`, уберите `@v0.2.3`.
...
"bitrix24-routine": {
  "command": "uvx",
  "args": ["--from", "git+https://github.com/a-shipilo/bitrix24-mcp-server@v0.2.3", "bitrix24-mcp-server"],
  "env": {
    "BITRIX24_WEBHOOK_URL": "https://your-portal.bitrix24.ru/rest/1/xxxxxxxxxxxxxxxx/",
